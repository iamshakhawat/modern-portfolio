        ...
        <div class="flex justify-between items-center h-20">
          ...
          text-gray-900 dark:text-white transition-all duration-300">
            ...
            <div class="hidden md:flex items-center space-x-2">
                <a href="{{ url()->current() == '/' ? "#home" : url('/#home') }}"
                ...
                <a href="{{ url()->current() == '/' ? "#about" : url('/#about') }}"
                ...
                <a href="{{ url()->current() == '/' ? "#skill" : url('/#skill') }}"
                ...
                <a href="{{ url()->current() == '/' ? "#projects" : url('/#projects') }}"
                ...
                <a href="{{ url()->current() == '/' ? "#services" : url('/#services') }}"
                ...
                <a href="{{ url()->current() == '/' ? "#contact" : url('/#contact') }}"
