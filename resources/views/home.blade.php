                        ...
                        <a href="{{ route('project.show', $project->slug) }}"
                            ...
                            <div class="p-6 text-left">
                                ...
                                @foreach ($project->categories->take(2) as $category)
                                    <span
                                        class="inline-block bg-indigo-600/50 text-indigo-200 text-xs font-semibold px-3 py-1 rounded-full mb-3 mr-2">{{ $category->name }}</span>
                                @endforeach
                                ...
                                <div class="flex space-x-3 text-xl justify-center md:justify-start">
                                    @foreach ($project->skills->take(11) as $skill)
                                        <i class="{{ $skill->icon }} " style="color: {{ $skill->color }}"
                                            title="{{ $skill->name }}"></i>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <ol class="relative border-l-4 border-indigo-200 dark:border-indigo-700">
                        ...
                        @forelse ($educations as $education)
                            <li class="mb-10 ml-6">
                                ...
                                <h4 class="text-xl font-semibold text-gray-900 dark:text-white">{{ $education->degree }}
                                </h4>
                                <p class="text-gray-600 dark:text-gray-300">{{ $education->institution }}</p>
                                <span
                                    class="block text-sm text-gray-500 dark:text-gray-400 mb-1">{{ $education->years }}</span>
                                @if ($education->status === 'Passed')
                                    <span
                                        class="inline-block px-3 py-1 text-xs font-semibold rounded-full bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300">{{ $education->status }}</span>
                                @else
                                    <span
                                        class="inline-block px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300">{{ $education->status }}</span>
                                @endif
                            </li>
                        @empty
                            <li class="mb-10 ml-6">
                    ...
                    <ol class="relative border-l-4 border-violet-200 dark:border-violet-700">
                        ...
                        @forelse ($experiences as $experience)
                            <li class="mb-10 ml-6">
                                ...
                                <h4 class="text-xl font-semibold text-gray-900 dark:text-white">{{ $experience->title }}
                                </h4>
                                <span
                                    class="block text-sm text-gray-500 dark:text-gray-400 mb-1">{{ $experience->duration }}</span>
                                <p class="text-gray-600 dark:text-gray-300">{{ $experience->company }}<br>
