        ...
        <div class="max-w-7xl mx-auto">
            <div
                ...
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Services List</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($services as $index => $skill)
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        @if ($skill->featured)
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-bold bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400">Featured</span>
                                        @else
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-bold bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400">Disable</span>
                                        @endif
                                    </td>
                                    <td class="px-4 py-3 flex space-x-2">
                                        <a href="{{ route('admin.services.edit', $skill->id) }}"
                                        ...
                                        <button type="button"
                                            onclick="deleteData('{{ route('admin.services.delete', $skill->id) }}')"
