        ...
        <div class="max-w-2xl mx-auto">
            <div
                ...
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Edit Service</h2>
                            ...
                            <div class="flex justify-between items-center">
                                <div class="mb-2">
                                    <span
                                        ...
                                        id="colorPreview" style="background: {{ old('color', $service->color ?? '#000000') }}"></span>
                                </div>
                                <input id="colorinput" type="color" name="color" value="{{ old('color', $service->color ?? '#000000') }}"
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set initial color for icon preview
            colorPreview.style.color = colorInput.value;
        });
    </script>
@endpush