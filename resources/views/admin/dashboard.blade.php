...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6 border-l-4 border-blue-500">
            ...
            <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ $stats['total_projects'] }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6 border-l-4 border-green-500">
            ...
            <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ $stats['total_contacts'] }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6 border-l-4 border-purple-500">
            ...
            <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ $stats['total_skills'] }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6 border-l-4 border-yellow-500">
            ...
            <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ $stats['total_services'] }}</p>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white mt-2">{{ $stats['total_testimonials'] }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white mt-2">{{ $stats['total_achievements'] }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white mt-2">{{ $stats['total_certifications'] }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-3xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white mt-2">{{ $stats['total_experiences'] }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.projects') }}" class="text-xs text-blue-500 hover:text-blue-700 font-semibold">
            ...
            <div class="space-y-4 overflow-y-auto max-h-80">
                @forelse($recentProjects as $project)
                    <div class="flex items-start space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-xl transition">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-semibold">{{ $project->title }}</p>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.contacts') }}" class="text-xs text-green-500 hover:text-green-700 font-semibold">
                    View All <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
            <div class="space-y-4 overflow-y-auto max-h-80">
                @forelse($recentContacts as $contact)
                    <div class="border-b border-gray-100 dark:border-slate-700 pb-3 last:border-0">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="text-sm text-gray-700 dark:text-gray-300 font-semibold">{{ $contact->name }}</p>
                                <p class="text-xs text-gray-500">{{ $contact->email }}</p>
                            </div>
                        </div>
                        <p class="text-xs text-gray-400 mt-2">{{ Str::limit($contact->message, 60) }}</p>
                        <p class="text-[10px] text-gray-400 mt-2">{{ $contact->created_at->diffForHumans() }}</p>
                    </div>
                @empty
    ...
    <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.testimonials') }}" class="text-xs text-pink-500 hover:text-pink-700 font-semibold">
                View All <i class="fas fa-arrow-right ml-1"></i>
            </a>
        </div>
            ...
            @forelse($latestTestimonials as $testimonial)
                <div class="p-4 bg-gray-50 dark:bg-slate-700 rounded-xl">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">{{ $testimonial->name }}</p>
                            <p class="text-xs text-gray-500">{{ $testimonial->position }}</p>
                        </div>
                    </div>
                    <p class="text-xs text-gray-600 dark:text-gray-400">{{ Str::limit($testimonial->message, 80) }}</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.skills') }}" class="text-xs text-purple-500 hover:text-purple-700 font-semibold">
                    View All <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
            <div class="space-y-4">
                @forelse($topSkills as $skill)
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">{{ $skill->name }}</span>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.projects') }}" class="text-xs text-yellow-500 hover:text-yellow-700 font-semibold">
                    View All <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
            <div class="space-y-4">
                @forelse($featuredProjects as $project)
                    <div class="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-slate-700 dark:to-slate-600 rounded-xl border border-yellow-200 dark:border-slate-600">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-sm font-bold text-gray-800 dark:text-white">{{ $project->title }}</p>
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">{{ Str::limit($project->short_description, 50) }}</p>
                                <div class="flex items-center space-x-2 mt-2">
                                    <span class="text-xs text-yellow-600 dark:text-yellow-400">
                                        <i class="fas fa-calendar mr-1"></i>{{ $project->date }}
                                    </span>
                                    <span class="text-xs text-yellow-600 dark:text-yellow-400">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.achievements') }}" class="text-xs text-yellow-500 hover:text-yellow-700 font-semibold">
                    View All <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
            <div class="space-y-3">
                @forelse($recentAchievements as $achievement)
                    <div class="flex items-start space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-xl transition">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">{{ $achievement->title }}</p>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.services') }}" class="text-xs text-blue-500 hover:text-blue-700 font-semibold">
                    View All <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
                ...
                @forelse($activeServices as $service)
                    <div class="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-700 dark:to-slate-600 rounded-xl border border-blue-100 dark:border-slate-600 text-center">
                        <div class="w-12 h-12 mx-auto rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-2">
                            <i class="fas fa-{{ $service->icon ?? 'cog' }} text-blue-600 dark:text-blue-400 text-xl"></i>
                        </div>
                        <p class="text-xs font-bold text-gray-800 dark:text-white">{{ $service->title }}</p>
                    </div>
                @empty
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('admin.projects') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-lg rounded-xl p-4 text-center text-white transition">
                <i class="fas fa-plus-circle text-2xl mb-2"></i>
                <p class="text-xs font-semibold">Add Project</p>
            </a>
            <a href="{{ route('admin.skills') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-lg rounded-xl p-4 text-center text-white transition">
                <i class="fas fa-tools text-2xl mb-2"></i>
                <p class="text-xs font-semibold">Add Skill</p>
            </a>
            <a href="{{ route('admin.services') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-lg rounded-xl p-4 text-center text-white transition">
                <i class="fas fa-concierge-bell text-2xl mb-2"></i>
                <p class="text-xs font-semibold">Add Service</p>
            </a>
            <a href="{{ route('admin.contacts') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 backdrop-blur-lg rounded-xl p-4 text-center text-white transition">
