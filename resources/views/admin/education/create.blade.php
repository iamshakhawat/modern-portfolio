        ...
        <div class="max-w-2xl mx-auto">
            <div
                ...
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Add New Education</h2>
                ...
                <div class="px-8 py-6">
                   ...
                   focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="years" id="years" value="{{ old('years') }}"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700
                                   bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        ...
                        <div class="mb-6">
                            ...
                            <select name="status" id="status"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700
                                   bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <option value="Passed" {{ old('status', 'Passed') == 'Passed' ? 'selected' : '' }}>
                                    Passed
                                </option>
