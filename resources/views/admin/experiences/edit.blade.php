        ...
        <div class="max-w-2xl mx-auto">
            <div
                ...
                <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Edit Experience</h2>
                ...
                <div class="px-8 py-6">
                    <form action="{{ route('admin.experiences.update', $experience->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="title" id="position" value="{{ old('title', $experience->title) }}"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                <span
                                    ...
                                    <i id="iconPreview" class="{{ old('icon', $experience->icon) }}"></i>
                                </span>
                                <input type="text" name="icon" id="iconInput" value="{{ old('icon', $experience->icon) }}"
                   ...
                   focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="duration" id="duration" value="{{ old('duration', $experience->duration) }}"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700
                                   bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700
                                   bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                placeholder="Describe your responsibilities or achievements">{{ old('description', $experience->description) }}</textarea>
                            @error('description')
                                <span class="text-xs text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
