        ...
        <div class="max-w-7xl mx-auto">
            <div
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">
                                        <?php echo e($skills->firstItem() + $index); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300 capitalize">
                                        <?php echo e($skill->category); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-semibold">
                                        <?php echo e($skill->name); ?></td>
                                    <td class="px-4 py-3">
                                        <span class="inline-flex items-center">
                                            <i class="<?php echo e($skill->icon); ?> text-xl" style="color: <?php echo e($skill->color); ?>"></i>
                                        </span>
                                    </td>
                                    <td class="px-4 py-3 flex items-center">
                                        <?php if($skill->color): ?>
                                            <span
                                                ...
                                                style="background: <?php echo e($skill->color); ?>"></span>
                                            <span class="ml-2 text-xs font-mono text-gray-500"><?php echo e($skill->color); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td class="px-4 py-3 flex space-x-2">
                                        ...
                                        <button type="button"
                                            onclick="deleteData('<?php echo e(route('admin.skills.delete', $skill->id)); ?>')"
                ...
                <div class="px-8 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-700">
                    <?php echo e($skills->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layout.admin.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Shakhawat\Desktop\Portfolio\resources\views/admin/skills/skills.blade.php ENDPATH**/ ?>