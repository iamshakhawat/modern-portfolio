                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">
                                        <?php echo e($projects->firstItem() + $index); ?></td>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300 scapitalize">
                                        ...
                                        <div>
                                            <?php $__currentLoopData = $project->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span
                                                    class="inline-block px-2 py-1 mr-1 mb-1 rounded-full text-xs font-bold bg-gray-100 dark:bg-gray-900/30 text-gray-700 dark:text-gray-300"><?php echo e($category->name); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-xs  text-gray-700 dark:text-gray-300">
                                        <?php echo e($project->rating); ?>
                                    ...
                                    <td class="px-4 py-3 text-xs  text-gray-700 dark:text-gray-300 ">
                                        ...
                                        <button type="button"
                                            onclick="deleteData('<?php echo e(route('admin.projects.delete', $project->id)); ?>')"
...
<?php echo $__env->make('layout.admin.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Shakhawat\Desktop\Portfolio\resources\views/admin/project/projects.blade.php ENDPATH**/ ?>